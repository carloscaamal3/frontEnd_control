...
import * as colonias from './modules/colonias.store'
...
import * as contratista from './modules/contratista.store'
import * as afianzadoras from './modules/afianzadoras.store'
import * as programas from './modules/programas.store'
import * as accion from './modules/accion.store'
import * as accionDetalle from './modules/accionDetalle.store'
import * as seccion from './modules/seccion.store'
import * as prespuestoAnual from './modules/prespuestoAnual.store'
import * as mvtoDetalle from './modules/mvtoDetalle.store'
import * as licitaciones from './modules/licitaciones.store'
import * as ciudadanos from './modules/ciudadanos.store'
import * as beneficiarios from './modules/beneficiarios.store'
import * as publicacion from './modules/publicacion.store'
Vue.use(Vuex)
