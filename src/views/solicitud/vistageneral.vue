<template>
  <v-container id="data-tables" tag="section">
    <base-material-card color="blue" icon="mdi-eye-settings-outline" inline class="px-5 py-3">
      ...
      <v-dialog v-model="dialogEdit" max-width="1024px">
        <v-card>
          <v-card-title>
 ...
 -->
            ...
            <v-expansion-panels v-model="panel" multiple>
              ...
              <v-expansion-panel>
                <v-expansion-panel-header>
                  1 - {{ editedItem.sp_estatus_1 }} ({{ editedItem.sp_fecha_solicitud }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    ...
                    <v-col cols="3" class="v-text">
                      ...
                      <div>
                        <p class="valor">$&nbsp;{{ formatPrice(editedItem.sp_importe) }}</p>
                      </div>
                    </v-col>
                    <!-- Campo Observacion -->
                    <v-col cols="12" class="v-text">
              ...
              <!-- ESTATUS 2 SOLFIRIDA-->
              <v-expansion-panel v-if="editedItem.sp_estatus_2 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  2 - {{ editedItem.sp_estatus_2 }} ({{ editedItem.sp_fecha_firma_sol_ida }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
              ...
              <!-- ESTATUS 3 SOLFIRVTA-->
              <v-expansion-panel v-if="editedItem.sp_estatus_3 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  3 - {{ editedItem.sp_estatus_3 }} ({{
              ...
              <!-- ESTATUS 4 AUTFIR-->
              <v-expansion-panel v-if="editedItem.sp_estatus_4 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  4 - {{ editedItem.sp_estatus_4 }} ({{ editedItem.sp_fecha_firma_aut_ida }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    <!-- Campo: -->
              ...
              <!-- ESTATUS 5 AUTFIRVTA -->
              <v-expansion-panel v-if="editedItem.sp_estatus_5 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  5 - {{ editedItem.sp_estatus_5 }} ({{ editedItem.sp_fecha_autoriza_vuelta }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
              ...
              <!-- ESTATUS 6 PAGOS -->
              <v-expansion-panel v-if="editedItem.sp_estatus_6 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  6 - {{ editedItem.sp_estatus_6 }} ({{ editedItem.sp_fecha_firma_aut_vuelta }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
              ...
              <!-- ESTATUS 7 GASCOM-->
              <v-expansion-panel v-if="editedItem.sp_estatus_7 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  7 -{{ editedItem.sp_estatus_7 }} ({{ editedItem.sp_fecha_conta_gasxcomp }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    ...
                    <v-col cols="6" class="v-text">
                      ...
                      <div>
                        <p class="valor">{{ editedItem.sp_id_gpo_firma_aut_vuelta_gxc }}</p>
                      </div>
                    </v-col>
              ...
              <!-- ESTATUS 8 FINPAGO -->
              <v-expansion-panel v-if="editedItem.sp_estatus_8 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  8 - {{ editedItem.sp_estatus_8 }} ({{ editedItem.sp_fecha_pago }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    <!-- Campo: tipo de pago -->
              ...
              <!-- ESTATUS 9 FINGXC-->
              <v-expansion-panel v-if="editedItem.sp_estatus_9 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  9 - {{ editedItem.sp_estatus_9 }} ({{ editedItem.sp_fecha_gxc_ent_conta }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    <!-- Campo: -->
              ...
              <v-expansion-panel v-if="editedItem.sp_estatus_10 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  10 - {{ editedItem.sp_estatus_10 }} ({{ editedItem.sp_fecha_por_cancelar }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
              ...
              <!-- ESTATUS 11 CANCELAR -->
              <v-expansion-panel v-if="editedItem.sp_estatus_11 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  11 - {{ editedItem.sp_estatus_11 }} ({{ editedItem.sp_fecha_cancelacion }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
                    ...
                    <v-col cols="4" class="v-text">
                      ...
                      <div>
                        <p class="valor">{{ editedItem.sp_poliza_ejercido_cancela }}</p>
                      </div>
                    </v-col>
              ...
              <v-expansion-panel v-if="editedItem.sp_estatus_12 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  12 - {{ editedItem.sp_estatus_12 }} ({{ editedItem.sp_fecha_folios }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
              ...
              <!-- EJERCIDO -->
              <v-expansion-panel v-if="editedItem.sp_estatus_13 != 'NO_APLICA'">
                <v-expansion-panel-header>
                  13 - {{ editedItem.sp_estatus_13 }} ({{ editedItem.sp_fecha_ejercido }})
                </v-expansion-panel-header>
                <v-expansion-panel-content>
                  <v-row>
      ...
      >
        ...
        <template v-slot:[`item.estatus_nombre`]="{ item }">
          <v-chip :color="getColor(item.sp_estatus)">
            {{ item.estatus_nombre }}
          </v-chip>
        </template>
...
export default {
  ...
  methods: {
    ...
    getColor(estatus) {
      ...
      else if (estatus == 'FINGXC') return '#00B0FF'
      else return 'yellow'
    },
